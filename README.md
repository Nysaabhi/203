...
const locatorsData = [
  // Delhi
  {
    ...
    details: {
      ...
      shortDescription: "Your favorite destination for groceries at unbeatable prices.",
      fullDescription: "Dmart is India's leading supermarket chain offering a wide range of grocery products, household essentials, and daily necessities at highly competitive prices. With a focus on efficiency and value, Dmart provides a no-frills shopping experience that helps customers save money on their everyday purchases.",
      ...
      rating: "4.3",
      tags: ["Discounts", "Daily Essentials", "Bulk Purchase"],
      images: [
      ...
      actionButtons: [
        {
          ...
          url: "https://www.dmart.in/products",
          type: "primary"
        },
        {
          text: "Directions",
          icon: "fas fa-directions",
          url: "https://maps.example.com/dmart",
          type: "secondary"
        }
      ]
    }
  },
  {
    ...
    details: {
      ...
      shortDescription: "Home of the Whopper. Flame-grilled burgers and fries.",
      fullDescription: "Burger King is the second largest fast food hamburger chain in the world, famous for its signature Whopper sandwich. Our flame-grilled burgers are made with 100% beef patties and served with fresh ingredients. We offer a variety of burgers, chicken sandwiches, salads, breakfast items, and desserts to satisfy every craving.",
      address: "Connaught Place, Delhi",
      ...
      rating: "4.1",
      tags: ["Fast Food", "Vegetarian Options", "Late Night"],
      images: [
      ...
      actionButtons: [
        {
          ...
          url: "https://www.burgerking.in/menu",
          type: "primary"
        },
        {
          text: "Directions",
          icon: "fas fa-directions",
          url: "https://maps.example.com/burgerking",
          type: "secondary"
        }
      ]
    }
  },
  {
    ...
    details: {
      ...
      shortDescription: "Your one-stop shop for electronics and appliances.",
      fullDescription: "Reliance Digital is India's leading electronics retail chain offering the latest in consumer electronics, home appliances, and gadgets. With expert staff, installation services, and competitive pricing, we provide a complete solution for all your technology needs. From smartphones to smart homes, we've got you covered.",
      ...
      rating: "4.6",
      tags: ["Electronics", "Appliances", "Installation"],
      images: [
      ...
      actionButtons: [
        {
          ...
          icon: "fas fa-laptop",
          url: "https://www.reliancedigital.in/products",
          type: "primary"
        },
        {
          text: "Directions",
          icon: "fas fa-directions",
          url: "https://maps.example.com/reliancedigital",
          type: "secondary"
        }
      ]
    }
  ...
  // Mumbai
  {
    ...
    details: {
      ...
      shortDescription: "India's largest hypermarket chain for groceries and more.",
      fullDescription: "Big Bazaar is India's favorite shopping destination for groceries, fashion, home needs, and more. With weekly offers and discounts, we bring value to your everyday shopping. Our stores are designed to provide a complete family shopping experience under one roof with quality products at affordable prices.",
      ...
      rating: "4.0",
      tags: ["Hypermarket", "Weekly Offers"],
      images: [
      ...
      actionButtons: [
        {
          text: "Weekly Offers",
          icon: "fas fa-tag",
          url: "https://www.bigbazaar.com/offers",
          type: "primary"
        },
        {
          text: "Directions",
          icon: "fas fa-directions",
          url: "https://maps.example.com/bigbazaar",
          type: "secondary"
        }
      ]
    }
...
/* Enhanced Locator Card Styling with Improved Mobile Responsiveness */
...
/* Carousel Controls with Better Touch Areas */
.carousel-control {
  position: absolute;
  top: 50%;
  transform: translateY(-50%);
...
/* Info Items with Consistent Spacing */
.locator-info {
  margin-top: 12px;
}
...
/* Optimization for portrait orientation on phones */
...
function renderLocatorCards(filteredData) {
  return filteredData.map(locator => {
    ...
    const actionButtonsHTML = locator.details.actionButtons 
      ? locator.details.actionButtons.map(button => `
    ...
    return `
      <div class="locator-card" onclick="openStorePage('${locator.category}')" aria-label="${locator.details.name}">
        <div class="image-carousel">
          ${locator.details.images.map((image, index) => `
            <div class="carousel-item ${index === 0 ? 'active' : ''}">
              <img src="${image}" alt="${locator.details.name}" onclick="openFullScreen('${image}')">
            </div>
          `).join('')}
          <div class="carousel-pagination">
            ${locator.details.images.map((_, index) => `
          ...
          <div class="locator-card-header">
            <div style="display: flex; justify-content: space-between; align-items: flex-start;">
              ...
              <div class="locator-rating">
                <span class="star">${locator.details.rating} ★</span>
              </div>
            </div>
            ...
            <div class="locator-info">
              <div class="locator-info-item">
                <i class="fas fa-clock"></i>
                <span>${locator.details.timings}</span>
              </div>
            </div>
            
        <p class="locator-description">${locator.details.shortDescription}</p>
        ${tagsHTML}
          </div>
        </div>
...
function openFullScreen(imageSrc) {
  ...
  fullScreenDiv.innerHTML = `
    <img src="${imageSrc}" alt="Full Screen Image" onclick="event.stopPropagation()">
    <button class="close-full-screen" onclick="closeFullScreen()">&times;</button>
  `;
...
function currentCarouselSlide(event, index) {
  event.stopPropagation();
  const carousel = event.target.closest('.image-carousel');
  const items = carousel.querySelectorAll('.carousel-item');
  const dots = carousel.querySelectorAll('.pagination-dot');
  ...
  storePage.innerHTML = `
    <div class="store-header">
      ...
      <div class="header-actions">
        <button class="share-button" onclick="shareLocation('${locator.details.name}')">
          <i class="fas fa-share-alt"></i>
        </button>
      </div>
    </div>
    ...
    <div class="store-content">
      ...
      <div class="store-hero">
        <div class="store-image-container">
          <img src="${locator.details.image}" alt="${locator.details.name}" class="store-image">
        </div>
        <div class="store-basic-info">
          <div class="store-rating">
            <i class="fas fa-star"></i> ${locator.details.rating}
          </div>
          <div class="store-category">
            ${locator.category}
          </div>
          <div class="store-timings">
            <i class="fas fa-clock"></i> ${locator.details.timings}
          </div>
        </div>
      </div>
    ...
    <div class="store-description-section">
      <h3>About</h3>
      <p>${locator.details.fullDescription}</p>
    </div>
      
      <!-- Location Section -->
      <div class="store-location-section">
        <h3>Locations in ${selectedMetropolis}</h3>
            ...
            <div class="location-card">
              <div class="location-info">
                ...
                <p class="location-address">
                  <i class="fas fa-map-marker-alt"></i> ${outlet.address}
                </p>
                <p class="location-timings">
                  <i class="fas fa-clock"></i> ${outlet.timings}
                </p>
              </div>
              <a href="${outlet.mapLink}" target="_blank" class="map-button">
      ...
      <div class="store-contact-section">
        ...
        <div class="contact-methods">
          ${locator.details.support?.phone ? `
            <a href="tel:${locator.details.support.phone}" class="contact-item">
              <i class="fas fa-phone"></i> ${locator.details.support.phone}
            </a>
          ` : ''}
          ${locator.details.support?.email ? `
            <a href="mailto:${locator.details.support.email}" class="contact-item">
              <i class="fas fa-envelope"></i> ${locator.details.support.email}
            </a>
          ` : ''}
          ${locator.details.menuLink ? `
            <a href="${locator.details.menuLink}" target="_blank" class="contact-item">
        ...
        <div class="social-links">
          ${locator.details.social?.facebook ? `
            <a href="${locator.details.social.facebook}" target="_blank" class="social-link">
              <i class="fab fa-facebook-f"></i>
            </a>
          ` : ''}
          ${locator.details.social?.twitter ? `
            <a href="${locator.details.social.twitter}" target="_blank" class="social-link">
              <i class="fab fa-twitter"></i>
            </a>
          ` : ''}
          ${locator.details.social?.instagram ? `
            <a href="${locator.details.social.instagram}" target="_blank" class="social-link">
              <i class="fab fa-instagram"></i>
            </a>
          ` : ''}
        </div>
      ...
      <div class="store-actions">
        <a href="${locator.details.mapLink}" target="_blank" class="primary-action">
          <i class="fas fa-directions"></i> Get Directions
        </a>
        <button class="secondary-action" onclick="showChatSupport('${locator.details.name}')">
...
function addStorePageStyles() {
  ...
  .map-button {
    ...
    margin-right: auto;
    transform: translateX(-5%);  /* Added slight left shift */
  }
    }
    ...
    @media (min-width: 1440px) {
      ...
      /* Action buttons with moderate centering effect */
  .store-actions {
    max-width: 800px;
    left: 40%;  /* Changed from 50% to 48% */
  }
    }
  `;
  document.head.appendChild(style);
      ...
      <div class="tab-content">
        ...
        <div id="support" class="tab-pane">
          <div class="customer-support" id="supportContent">
            ...
            <button onclick="showChatSupport('${place.details.name}')">
              <i class="fas fa-comments"></i> Chat with Us
            </button>
          </div>
        </div>
